...
import org.azrul.services.banking.domain.Customer;
import org.azrul.services.banking.repository.CustomerRepository;
import org.azrul.services.banking.service.CustomerService;
import org.azrul.services.banking.service.dto.CustomerDTO;
import org.azrul.services.banking.service.mapper.CustomerMapper;
...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_IC_NUMBER = "AAAAAAAAAA";
    private static final String UPDATED_IC_NUMBER = "BBBBBBBBBB";
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getIcNumber()).isEqualTo(DEFAULT_IC_NUMBER);
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cifNumber").value(hasItem(DEFAULT_CIF_NUMBER.toString())))
            .andExpect(jsonPath("$.[*].firstName").value(hasItem(DEFAULT_FIRST_NAME.toString())))
            .andExpect(jsonPath("$.[*].lastName").value(hasItem(DEFAULT_LAST_NAME.toString())))
            .andExpect(jsonPath("$.[*].icNumber").value(hasItem(DEFAULT_IC_NUMBER.toString())))
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.cifNumber").value(DEFAULT_CIF_NUMBER.toString()))
            .andExpect(jsonPath("$.firstName").value(DEFAULT_FIRST_NAME.toString()))
            .andExpect(jsonPath("$.lastName").value(DEFAULT_LAST_NAME.toString()))
            .andExpect(jsonPath("$.icNumber").value(DEFAULT_IC_NUMBER.toString()))
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getIcNumber()).isEqualTo(UPDATED_IC_NUMBER);
